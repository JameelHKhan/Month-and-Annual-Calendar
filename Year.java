...
public class Year 
{
  public static void main ( String [] args)
  {
	  ...
	  int y = 0;  // value for input, represents year
	  int m = 1;  // represents month, used throughout program for calendar generation
	  
	  // Use a Scanner to input year value
	  ...
	  printYearCalendar( m, y );
  } // end of main method
  
/*
 * The method printYearCalendar() uses a for loop to call the method printMonthCalendar()
 * in order to print out a yearly calendar for the inputed year.
 * 
 * @param m is month of the year, initially predetermined as 1 and incremented up to 12
 * @param y is the year chosen by the user
 * 
 * Precondition: m is an int, starting at 1 and incrementing to 12
 *               y is a four-digit int inputed by the user
 * 
 * Postcondition: A visual display of 12 calendar months for the inputed year
 */
  public static void printYearCalendar( int m, int y )
  {
	  for( m = 1; m < 13; m++)
	  {
		  printMonthCalendar( m, y );
	  } // end of for loop
  } // end of method printYearCalendar()
...
/*
 * The method isLeapYear() determins whether the year inputed by the user is a leap
